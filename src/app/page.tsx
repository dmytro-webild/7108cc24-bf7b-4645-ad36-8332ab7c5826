...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/house-backyard-street-color-back_1203-4994.jpg",
          imageAlt: "Full exterior window detail",
        },
      ]}
    />
  </div>
  ...
  <div id="services" data-section="services">
      ...
      features={[
        ...
        },
        {
          ...
          items: [
            {
              text: "Frame wipe-down",
              icon: CheckCircle,
            },
            {
              text: "Corner detail attention",
              icon: CheckCircle,
            },
            {
              text: "Surface brightening",
              icon: CheckCircle,
            },
          ],
          reverse: true,
  ...
  <div id="gallery" data-section="gallery">
      ...
      products={[
        {
          id: "1",
          name: "Front Window Detail",
          price: "Before & After",
          imageSrc: "http://img.b2bpic.net/free-photo/handsome-young-carpenter-working-with-experienced-man_329181-15697.jpg",
        },
        {
          id: "2",
          name: "Second-Story Windows",
          price: "Before & After",
          imageSrc: "http://img.b2bpic.net/free-photo/people-installing-window-curtain_53876-30624.jpg",
        },
        {
          id: "3",
          name: "Frame Detail Focus",
          price: "Before & After",
          imageSrc: "http://img.b2bpic.net/free-photo/man-doing-professional-home-cleaning-service_23-2150359028.jpg",
        },
        {
          id: "4",
          name: "Streak-Free Finish",
          price: "Before & After",
          imageSrc: "http://img.b2bpic.net/free-photo/photo-wall-texture-pattern_58702-12601.jpg",
        },
        {
          id: "5",
          name: "Sill & Ledge Refresh",
          price: "Before & After",
          imageSrc: "http://img.b2bpic.net/free-photo/focused-woman-using-gadget-opening-shades_259150-57137.jpg",
        },
        {
          id: "6",
          name: "Overall Curb Appeal",
          price: "Before & After",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "1",
          title: "What's included in your exterior window cleaning?",
          content: "We clean the exterior glass plus the frames and sills/ledges for a complete, detailed finish.",
        },
        {
          id: "2",
          title: "Do you clean second-story windows?",
          content: "Yes, we handle all hard-to-reach exterior windows using safe professional tools.",
        },
        {
          id: "3",
          title: "How often should windows be cleaned?",
          content: "Most homes benefit from a professional detail every 3-6 months depending on environmental factors.",
        },
        {
          id: "4",
          title: "Do I need to be home?",
          content: "No, as long as exterior access is available and we've confirmed the appointment.",
        },
        {
          id: "5",
          title: "Are estimates free?",
          content: "Yes, we provide fast, no-obligation estimates via phone, text, or photo review.",
        },
      ]}
